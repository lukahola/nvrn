...
def test_ego_allo():
    ...
    for src_type in rot_types:
        for dst_type in rot_types:
            allo_pose = egocentric_to_allocentric_gl(ego_poses[src_type], src_type, dst_type)
            ego_pose_1 = allocentric_to_egocentric_gl(allo_pose, dst_type, src_type)
