...
from .engine_utils import get_out_coor, get_out_mask, get_out_norm, cal_pose, ang_rectify
    ...
    def process_norm(self, inputs, outputs, out_dict):
        ...
        for i, (_input, output) in enumerate(zip(inputs, outputs)):
            ...
            for inst_i in range(len(_input["roi_img"])):
                ...
                _, rot_est = cal_pose(norm_stc_i, norm_dyn_i, mask_i, thresh=0.5, method=cfg.TEST.SVD_TYPE.lower())
                trans_est = out_transes[inst_i]
