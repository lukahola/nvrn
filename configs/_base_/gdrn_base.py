...
MODEL = dict(
    ...
    CDPN=dict(
        ...
        ROT_HEAD=dict(
            ...
            XYZ_LW=1.0,
            NORM_LOSS_TYPE="L1",  # L1 | CE_coor
            NORM_LOSS_MASK_GT="visib",  # trunc | visib | obj
            NORM_LW=1.0,
            ...
            DEPTH_LOSS_TYPE="Smooth_L1",  # L1 | CE_depth | Smooth_L1 | L2
            ...
            CROSS_NORM_LW=1.0,
            CROSS_NORM_LOSS_START=0.8,
            DEPTH_LOSS_MASK_GT="visib",  # trunc | visib | obj
        ),
        ...
        PNP_NET=dict(
            ...
            COORD_TYPE='abs',  # abs | rel | rel-aniso | rel-iso
            ...
            ROT_TYPE="ego_rot6d",
            TRANS_TYPE="centroid_z",  # trans | centroid_z (SITE) | centroid_z_abs | centroid_z_rec
            Z_TYPE="REL",  # REL | ABS | LOG | NEG_LOG  (only valid for centroid_z) | rel
            # point matching loss
            NUM_PM_POINTS=3000,
        ...
        SVD_NET=dict(
            ...
            LR_MULT=1.0,
            # ConvPnPNet | SimplePointPnPNet | PointPnPNet | ResPointPnPNet
            SVD_HEAD_CFG=dict(type="ConvSVDNet", norm="GN", num_gn_groups=32, drop_prob=0.0),  # 0.25
            # PNP_HEAD_CFG=dict(
            #     type="ConvPnPNet",
            #     norm="GN",
            #     num_gn_groups=32,
...
TEST = dict(
    ...
    USE_SVD=False,  # use svd or direct prediction
    SVD_TYPE='all_once',
    SAVE_NORMAL=False, # save normal_results
